<template>
  <main class="min-h-screen bg-background text-on-background font-body-md selection:bg-primary/30 overflow-x-hidden relative" @mousemove="onMouseMove">
    
    <!-- STICKY HEADER -->
    <header class="fixed top-0 left-0 right-0 z-40 bg-background/80 backdrop-blur-md border-b border-border px-6 py-4 flex justify-between items-center transition-all select-none">
      <NuxtLink to="/" class="spring-btn">
        <img :src="isDark ? LogoTextDark : LogoTextLight" class="h-6 w-auto" alt="Memories Logo" />
      </NuxtLink>

      <!-- Center Nav Links -->
      <nav class="hidden md:flex items-center gap-8 text-[12px] uppercase font-label-md tracking-widest text-secondary/80">
        <a href="#philosophy" class="hover:text-primary transition-colors">Philosophy</a>
    ...
    <section class="min-h-screen relative flex flex-col justify-center items-center py-32 px-6 md:px-12 overflow-hidden select-none">
      ...
      <div class="relative text-center max-w-4xl z-20 space-y-6">
        ...
        <h1 class="font-poetic-accent text-[80px] sm:text-[120px] md:text-[160px] leading-none italic font-normal tracking-tighter text-on-background select-none reveal-item" style="animation-delay: 200ms;">
          memories
        </h1>
        
        <p class="font-body-lg text-lg md:text-xl text-secondary max-w-lg mx-auto leading-relaxed reveal-item" style="animation-delay: 300ms;">
      ...
      <div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-secondary/40 font-label-sm text-[10px] tracking-widest reveal-item animate-pulse" style="animation-delay: 600ms;">
    ...
    <!-- PHILOSOPHY SECTION -->
    <section id="philosophy" class="bg-surface py-28 px-6 border-t border-b border-border scroll-mt-20">
      <div class="max-w-3xl mx-auto text-center space-y-12">
        ...
        <cite class="font-label-sm text-[11px] uppercase tracking-widest text-secondary not-italic block -mt-6">
          — Anaïs Nin
        </cite>
    ...
    <section id="features" class="py-28 px-6 max-w-5xl mx-auto scroll-mt-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
        ...
        <div class="col-span-1 md:col-span-8 bg-surface p-8 md:p-10 border border-border shadow-sm flex flex-col justify-between space-y-8 hover:shadow-md transition-shadow">
          <div class="space-y-4">
          ...
          <div class="text-[11px] font-label-sm text-on-surface-variant/40 tracking-wider">
            END-TO-END JWT AUTHENTICATION // HASHPASS
          </div>
        </div>

        <!-- Feature 2: Physical Layout (Tall) -->
        <div class="col-span-1 md:col-span-4 bg-surface p-8 border border-border shadow-sm flex flex-col justify-between space-y-8 hover:shadow-md transition-shadow">
          <div class="space-y-4">
